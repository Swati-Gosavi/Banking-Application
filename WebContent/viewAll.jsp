...
<body>    
     ...
     <center> <h3> <a href="createAcc.html"> Create Account </a> </h3> </center>   
...
<%
	...
	try
	{
		...
		PreparedStatement ps1 = con.prepareStatement("select * from users_tbl");
...
%>
		    ...
		    <td><a href="delete.jsp?accno=<%=rs.getString("accno")%>"> Delete </a></td>
		  </tr>
